...
The concept of max pressure control is intuitive: at each intersection, priority is given to the phase which will be able to service the most traffic given both available upstream demand and the subsequent feasibility of downstream queues. It is a particularly attractive concept for control of a signalized urban traffic network because ... TODO... 
...
TODO: re-do this organization description. 
